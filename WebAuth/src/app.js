...
Amplify.configure({
    Auth: {
        ...
        userPoolId: 'eu-west-1_c20LHRH9A',

        // OPTIONAL - Amazon Cognito Web Client ID (26-char alphanumeric string)
        userPoolWebClientId: '6bgvockq5oeagdrlmo969g19s9',
        ...
        endpoints: [
            {
                ...
                endpoint: "https://q7xr2gk8y3.execute-api.eu-west-1.amazonaws.com",
                region: "eu-west-1"
            }
        ]
    }
...
RequestToSecuredEndpointButton.addEventListener('click', async evt => {
  ...
  await API.get("MyAPIGatewayAPI", '/dev/api/get-together', myInit).then(response => {
